...
data work2;
	...
	/*
	array dummyb (4) 6. milstatus_ls3_cat1-milstatus_ls3_cat4;
	do i=1 to 4;
		dummyb(i)=0;
	end;
	dummyb(milstatus_ls3_cat)=1;
	*/
...
PROC EXPORT DATA = for_stata
            OUTFILE = "/home/data/Harvard/king/ls3/covid/new/data/covid_stress_vars.csv"
            DBMS = CSV
            REPLACE;
run;
...
proc surveyfreq data=work2 ;
	...
	strata sestrat;
	cluster secluster;
	tables c12 c12_cat c15 c9_other c11_lovedone1b c11_other1b c9_hhold1b c9_friend1b c9_other1b;
	tables (c12_1b c14 c17 c20 c21 c7_cat c11_lovedone_cat c11_other_cat c9_hhold_cat c9_friend_cat c9_other_cat)*ls3d5_covid_mde30 /row;
	tables (c12_1b c14 c17 c20 c21 c7_cat c11_lovedone_cat c11_other_cat c9_hhold_cat c9_friend_cat c9_other_cat)*ls3d5_gad30 /row;
	tables (c12_1b c14 c17 c20 c21 c7_cat c11_lovedone_cat c11_other_cat c9_hhold_cat c9_friend_cat c9_other_cat)*ls3d5_pts30 /row;
	tables (c12_1b c14 c17 c20 c21 c7_cat c11_lovedone_cat c11_other_cat c9_hhold_cat c9_friend_cat c9_other_cat)*ls3d5_covid_rupa30 /row;
	tables (c12_1b c14 c17 c20 c21 c7_cat c11_lovedone_cat c11_other_cat c9_hhold_cat c9_friend_cat c9_other_cat)*ls3_dx1plus_30 /row;
	*tables (race_cat ed_cat)*ls3d5_covid_rupa30 /row;
